package com.IoTeam.ThirstySeedAPI.iam.infrastructure.tokens.jwt;
 ...
 * This interface is used to inject the JWT token service in the {@link com.IoTeam.ThirstySeedAPI.iam.infrastructure.tokens.jwt.services} class.
 */
